        ...
        >
          ...
          >
            <HeartButton
              ...
              handleClickHeartButton={() => handleClickHeartButton(id)}
            />
          </TouchableOpacity>
          <View style={styles.infoContainer}>
            ...
            {ratingDetail.totalRating ? (
              ...
              >
                ...
                >
                  <Text style={styles.ratings}>{ratingDetail.avgRate}</Text>
                  <View>
                    <View
                      style={{
                        flexDirection: "row",
                    ...
                    >
                      {Array.from({
                        length: Math.floor(ratingDetail.avgRate || 0),
                      }).map((_, index) => (
                        <Icon
                          key={index}
                          name="star"
                      ...
                      {(ratingDetail.avgRate || 0) -
                        Math.floor(ratingDetail.avgRate || 0) >
                        0 && (
                        <Icon
                          name="star"
                          size={18}
            ...
            <View style={styles.hostView}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={{ color: "#5E5D5E", width: "100%" }}>
          ...
          <View style={styles.container_map}>
            <MapView
              style={{ flex: 1 }}
              initialRegion={{
                latitude: roomDetail.roomblock.coordinate.latitude,
                longitude: roomDetail.roomblock.coordinate.longitude,
                latitudeDelta: 0.1,
                longitudeDelta: 0.05,
              }}
            >
              <Marker coordinate={roomDetail.roomblock.coordinate}></Marker>
            </MapView>
          </View>
        </ScrollView>
      </View>
